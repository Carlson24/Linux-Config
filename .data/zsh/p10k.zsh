# Generated by Powerlevel10k configuration wizard on 2025-03-18 at 09:24 CST.
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='󰄛'
...
# catppuccin theme
source $ZSH_CUSTOM/themes/catppuccin/mocha.p10k.zsh
